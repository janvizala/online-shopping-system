    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Our Products</h1>
                    <p>We have the best collection of clothes as well as accesorries.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/best_selling_1.jpg" alt="suit1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Beige Suit</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/best_selling_3.jpg" alt="wtshirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>White Tshirt</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/best_selling_2.jpg" alt="blackshrug">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Black Shrug</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/on_sale_2.jpg" alt="bluehoodie">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Hoodie</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/c_t-shirt_men.png" alt="menupper">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Unique shirt</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/top_rated_1.jpg" alt="jeansshirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Denim Shirt</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/top_rated_3.jpg" alt="redhoodie">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Red Hoodie</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/on_sale_3.jpg" alt="sportshoes">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sport Shoes</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/smartw.jpeg" alt="smartwatch">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Smart Watch</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/c_formal_gray_shirt.png" alt="transparenttop">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Top</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/c_pant_girl.png" alt="girlpant">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Pant</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/c_polo-shirt.png" alt="PINKpolo">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/c_shirt-girl.png" alt="blueTOP">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Unique blue Top</h3>
                                    <p>Price: Rs.1000</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/c_tunic-shirt_girl.png" alt="blackshirt">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/c_undershirt.png" alt="bluetop">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Women darkblue top</h3>
                                    <p>Price: Rs.2000</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="images/c_western-shirt.png" alt="blacktop">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Women Black Top</h3>
                                    <p>Price: Rs.2200</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
